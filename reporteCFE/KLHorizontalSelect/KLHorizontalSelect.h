...
//Control Properties
#define kDefaultCellWidth 106.66      //The width of each of the items
#define kDefaultCellHeight 106.66       //Height of the items/control
#define kDefaultGradientTopColor  [UIColor whiteColor/*colorWithRed: 242/255.0 green: 243/255.0 blue: 246/255.0 alpha: 1*/]   //Top Gradient Color
#define kDefaultGradientBottomColor  [UIColor whiteColor/*colorWithRed: 197/255.0 green: 201/255.0 blue: 204/255.0 alpha: 1*/]    //Bottom Gradient Color
#define kDefaultLabelHeight 30.0    //Adjusts the height of the label
#define kDefaultImageHeight 0    //Adjusts the height of the image
