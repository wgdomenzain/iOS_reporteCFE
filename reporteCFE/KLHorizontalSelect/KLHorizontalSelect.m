...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    /*
    KLHorizontalSelectCell *cell = (KLHorizontalSelectCell*)[self.tableView cellForRowAtIndexPath:indexPath];
    cell.label.font             = [UIFont fontWithName: @"OpenSans" size: 16.0];
     */
}
...
-(UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.label.font            = [UIFont fontWithName: @"OpenSans-Light" size: 16.0];
    ...
    cell.label.highlightedTextColor = [UIColor nBlueGoogle100];
...
-(id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        self.label = [[UILabel alloc] initWithFrame:CGRectMake(0, 10, containingView.frame.size.width, kDefaultLabelHeight)];
        ...
        self.label.font            = [UIFont fontWithName: @"OpenSans-Light" size: 16.0];
